...
import org.gradle.jvm.toolchain.NewJavaCompilerFactory;
...
public class JavaToolChainServiceRegistry extends AbstractPluginServiceRegistry {
    ...
    private static class BuildSessionScopeCompileServices {
        ...
        NewJavaCompilerFactory createNewJavaCompilerFactory(ExecHandleFactory execHandleFactory) {
            return new NewJavaCompilerFactory() {
                @Override
                public Compiler<?> create(CompileSpec spec) {
